...
public:
    ...
    bool bookSeats(const string& bookingId, const string& showId,
        ...
        // HINT: Validate row/col bounds, check status
        // If any seat fails, return false immediately (atomic check)

        // TODO: Second pass — book ALL seats
        // HINT: Set status to BOOKED, set bookedBy to userId
...
int main() {
    cout << "BookMyShow Part 1 — implement the TODO methods above, then run tests." << endl;
    return 0;
}
#endif
